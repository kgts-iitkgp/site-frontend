...
const EventCard: React.FC<EventCardProps> = ({ event, type, openPopup }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row border-accentColor border-opacity-90 border-2 rounded-lg shadow-lg overflow-hidden w-full">
        {/* Image Section */}
        ...
        <div className="p-6 w-full lg:w-1/2 flex flex-col justify-between">
          <h3 className="text-xl lg:text-2xl font-semibold mb-4 text-secondaryColor uppercase font-com">
            {event.title}
          </h3>
          ...
          {type=== 'upcoming' &&(
            <div className='text-secondaryColor font-description'>
